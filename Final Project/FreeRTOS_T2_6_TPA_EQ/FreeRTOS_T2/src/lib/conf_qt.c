...
{
	gpio_configure_pin(QT1081_TOUCH_SENSOR_ENTER, GPIO_DIR_INPUT); // PB26 - 58		IRQ - 64 + pin/8 = 64+7 = 71	 (64 = 2 -> group * 32)
	gpio_configure_pin(QT1081_TOUCH_SENSOR_LEFT,  GPIO_DIR_INPUT); // PB25 - 57		IRQ = 71
	gpio_configure_pin(QT1081_TOUCH_SENSOR_RIGHT, GPIO_DIR_INPUT); // PB24 - 56		IRQ = 71
	gpio_configure_pin(QT1081_TOUCH_SENSOR_UP,	  GPIO_DIR_INPUT); // PB22 - 54		IRQ = 70
	gpio_configure_pin(QT1081_TOUCH_SENSOR_DOWN,  GPIO_DIR_INPUT); // PB23 - 55		IRQ = 70
	/* gpio_configure_pin 
